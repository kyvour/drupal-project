# this repository was moved to [https://github.com/andrew-yustyk/drupal-project](https://github.com/andrew-yustyk/drupal-project)
...
```
composer create-project kyvour/drupal-project:8.4.0-beta1 --prefer-dist --stability dev --no-interaction
```
...
To add a patch to drupal module foobar insert the patches section in the patches.json file:
```json
{
    "patches": {
        "drupal/foobar": {
